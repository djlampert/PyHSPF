...
compile_hspf.txt -- a batch file provide in text form (.txt) to build an HSPF
...
make_messagefile.py -- a Python script to build the message file

HSPF13.zip -- contains minor modifications to HSPF source code needed to develop
