...
1. Building an HSPF (hypothetical example with no external data sources)
...
6. Utilizing PyHSPF's built-in extractor for the Global Historical Climate Network Daily data set
7. Repeat of example 1 but illustrating the use of Special Actions
