...
Database (DSI-3240), and the National Water Information System. The 
preprocessing modules can calculate daily or hourly reference 
evapotranspiration time series using the ASCE Penman-Monteith Equation. 
This is a major difference from the other databases available for HSPF.
The climate data extractors/Penman calculator can be used completely 
outside HSPF.
